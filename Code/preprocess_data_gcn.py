...
with open('/wrk/users/sjsuomel/gcn/gcn/data/ind.small.y', 'wb') as handle:
    pickle.dump(train_labels, handle, protocol=pickle.HIGHEST_PROTOCOL)

test_labels = label_matrix[test_index,:]
with open('/wrk/users/sjsuomel/gcn/gcn/data/ind.small.ty', 'wb') as handle:
...
with open('/wrk/users/sjsuomel/gcn/gcn/data/ind.small.ally', 'wb') as handle:
    pickle.dump(label_matrix_no_test, handle, protocol=pickle.HIGHEST_PROTOCOL)

with open('/wrk/users/sjsuomel/gcn/gcn/data/ind.small.test.index', 'w') as f:
...
with open('/wrk/users/sjsuomel/gcn/gcn/data/ind.small.allx', 'wb') as handle:
...
with open('/wrk/users/sjsuomel/gcn/gcn/data/ind.small.x', 'wb') as handle:
...
with open('/wrk/users/sjsuomel/gcn/gcn/data/ind.small.tx', 'wb') as handle:
...
with open('/wrk/users/sjsuomel/gcn/gcn/data/ind.small.graph', 'wb') as handle:
